...
| **Zaměření**       | Spotřeba zdrojů (CPU, RAM, GC…)         | Celkový výkon a odezva pod zátěží |
...
- **nízký overhead** – minimální dopad na výkon i paměť, aby byl použitelný i v produkci
...
- často je nutný kompromis mezi časem, pamětí a spolehlivostí
...
- **Minor GC** – Mark-Sweep v Eden
- **Major GC** – zastaví JVM (Stop‑the‑world), Mark-Sweep nad celým heapem
- concurrent Mark‑Sweep snižuje pauzy u MajorGC
