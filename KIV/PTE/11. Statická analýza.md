...
- **Požadavek**: ne‑komplexní techniky, žádné symbolické ani konkolické vykonávání
...
- v AST reprezentace programu, jen důležité věci
...
- **Soundness:** pokud analýza tvrdí, že vlastnost platí, platí ve všech možných bězích programu.
- **Completeness:** analýza zachytí všechny relevantní cesty/kombinace; v praxi často nedosažitelná, což vede k false‑positivům nebo false‑negativům.
